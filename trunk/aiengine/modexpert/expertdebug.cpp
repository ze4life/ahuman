...
void AIExpertDebug::onMessage( Message *msg )
{
	XmlCall& call = msg -> toXmlCall();
	String fn = call.getFunctionName();

	try {
		if( fn.equals( "expert::testCreateBySamples" ) )
			testCreateBySamples( call );
		else
		if( fn.equals( "expert::testFinderPlay" ) )
			testFinderPlay( call );
		else
		if( fn.equals( "expert::testFinderFactory" ) )
...
void AIExpertDebug::testFinderPlay( XmlCall& call )
{
	AIExpertImpl *expert = AIExpertImpl::getServiceImpl();
	NNFinderFactory *ff = expert -> getFinderFactory();
...
void AIExpertDebug::testFinderFactory( XmlCall& call )
{
	AIExpertImpl *expert = AIExpertImpl::getServiceImpl();
	NNRegressionFactory *ff = expert -> getRegressionFactory();

...
void
	rfc_hm_mset( rfc_huge *p_hm , int p_level , const void *p_value , int p_idx1 , ...  )

{
	va_list l_va;
	
	va_start( l_va , p_idx1);
...
const rfc_hugeel *
	rfc_hm_mget( rfc_huge *p_hm , int p_level , int p_idx1 , ... )
...
rfc_huge*	rfc_hm_mgetsub( rfc_huge *p_hm , int p_level , int p_idx1 , ...   )
{
	va_list l_va;
	va_start( l_va, p_idx1 );

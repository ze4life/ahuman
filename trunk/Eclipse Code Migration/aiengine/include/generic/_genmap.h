...
/* create map */
extern rfc_map * 
	rfc_map_create( int p_type , int p_keys , short p_isnum1 , ...  );
extern rfc_map * 
...
/* add item to map */
/* TODO: Changed to migrate to eclipse */
extern int rfc_map_add( rfc_map *p_map , const RFC_TYPE *p_value , const void *p_keyval1 , ... );
extern int
...
/* find item data */
/* TODO: Changed to migrate to eclipse */
extern int rfc_map_check(  rfc_map *p_map , RFC_TYPE *p_value , const void *p_keyval1 , ...  );
extern int

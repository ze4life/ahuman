	...
	for( int z = 0; z < 100; z++ )
		{
			...
			// sort by value
			/* TODO: Commented while eclipse migration */
...
bool NNStrategyScanIteration::chooseBestAxisItems( NNScanPoint *p_spStartPoint )
{
	...
	/* TODO: Commented while eclipse migration */
	//Sort<int, NNStrategyScanIteration> doSort( axisIndex , nVars , this , onSortAxis );
	...
	while( mi.nextDistinctUnsorted() )
		{
			...
			/* TODO: Commented while eclipse migration */
			//Sort<int, NNStrategyScanIteration> doSortFirst( axes , axisItems , this , onSortAxisFirst );

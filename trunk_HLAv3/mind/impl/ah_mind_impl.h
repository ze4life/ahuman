...
extern neurovt_state	NEURON_SYNAPTIC_THRESHOLD_pQ;						// default level after which action potential reaches soma membrane
...
extern neurovt_state	NEURON_FIRE_OUTPUT_THRESHOLD_pQ;					// level after which membrane potential produces fire event

...
{//=====================================================
	...
	buf[0] = 0;
	//Sarbjit changes typecasting
	RegOpenKeyEx(HKEY_LOCAL_MACHINE, (LPCWSTR)"Software\\Microsoft\\Speech\\Voices\\Tokens\\eSpeak", 0, KEY_READ, &RegKey);
	size = sizeof(buf);
	var_type = REG_SZ;
	//Sarbjit changes typecasting
	RegQueryValueEx(RegKey, (LPCWSTR)"path", 0, &var_type, buf, &size);
